document.addEventListener('DOMContentLoaded', () => {
    ...
    const albums = {
        '1': [
            ...
            { title: 'KARINA FOR LOVE - lively Karina', src: 'LIVELY.MP3' }, // 修正：mp3 -> MP3
            { title: 'KARINA FOR LOVE - love Karina', src: 'LOVE.MP3' }, // 修正：mp3 -> MP3
            { title: 'KARINA FOR LOVE - lucky Karina', src: 'lucky Karina.WAV' },
        ],
        '2': [
            { title: 'Love at first sight - Down', src: 'Down.mp3' },
            { title: 'Love at first sight - Don\'t Cry', src: 'Don\'t Cry.mp3' },
            { title: 'Love at first sight - Inertia', src: 'Inertia.mp3' },
            { title: 'Love at first sight - Crush', src: 'Crush.mp3' },
            { title: 'Love at first sight - Salt Air', src: 'Salt Air.mp3' },
            { title: 'Love at first sight - Paper Boats', src: 'Paper Boats.mp3' },
            { title: 'Love at first sight - Thermal', src: 'Thermal.mp3' },
            { title: 'Love at first sight - I 🖤 U', src: 'I 🖤 U.mp3' },
            { title: 'Love at first sight - Game Over', src: 'Game Over.mp3' },
            { title: 'Love at first sight - Unlike Amateur ！', src: 'Unlike Amateur ！.mp3' },
        ]
    };
